package org.logicahealth.platform.authentication.persona;

import org.logicahealth.platform.service.JwtService;
...
public class PersonaAuthInterceptor extends HandlerInterceptorAdapter {
    ...
    private void authenticatePersonaUser(HttpServletRequest httpServletRequest) {
        ...
        if (hspcPersonaTokenCookie == null || !jwtService.jwtIsValid(hspcPersonaTokenCookie.getValue())) {
            return;
        }

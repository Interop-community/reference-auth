...
export IMAGE_COORDINATES="hspconsortium/hspc-reference-auth-server-webapp:1.13.0-SNAPSHOT"
export IMAGE_COORDINATES_ESCAPED="hspconsortium\/hspc-reference-auth-server-webapp:1\.13\.0-SNAPSHOT"
